...
data class Button(
    ...
    private fun Button.setData(text: Bind<String>, rootView: RootView) {
        styleId?.let { style ->
            val typedArray = _root_ide_package_.br.com.zup.beagle.android.components.styleManagerFactory.getButtonTypedArray(context, style)
            ...
            _root_ide_package_.br.com.zup.beagle.android.components.styleManagerFactory.getButtonStyle(style)?.let { buttonStyle ->
