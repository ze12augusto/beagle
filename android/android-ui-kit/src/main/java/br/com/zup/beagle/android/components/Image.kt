...
@RegisterWidget
data class Image(
    val path: Bind<_root_ide_package_.br.com.zup.beagle.android.components.PathType>,
    val mode: ImageContentMode? = null
) : WidgetView() {
    constructor(
        path: _root_ide_package_.br.com.zup.beagle.android.components.PathType,
    ...
    override fun buildView(rootView: RootView): View {
        ...
        observeBindChanges(rootView, path) { pathType ->
            when (pathType) {
                is _root_ide_package_.br.com.zup.beagle.android.components.PathType.Local -> {
                    imageView.apply {
                ...
                is _root_ide_package_.br.com.zup.beagle.android.components.PathType.Remote -> {
...
sealed class PathType {
    data class Local(val mobileId: String) : _root_ide_package_.br.com.zup.beagle.android.components.PathType()
    data class Remote(val url: String, val placeholder: _root_ide_package_.br.com.zup.beagle.android.components.PathType.Local? = null) : _root_ide_package_.br.com.zup.beagle.android.components.PathType()
}
