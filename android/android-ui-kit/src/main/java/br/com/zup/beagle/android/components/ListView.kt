...
) : RecyclerView.Adapter<_root_ide_package_.br.com.zup.beagle.android.components.ViewHolder>() {

    override fun getItemViewType(position: Int): Int = position

    override fun onCreateViewHolder(parent: ViewGroup, position: Int): _root_ide_package_.br.com.zup.beagle.android.components.ViewHolder {
        ...
        return _root_ide_package_.br.com.zup.beagle.android.components.ViewHolder(view)
    }

    override fun onBindViewHolder(holder: _root_ide_package_.br.com.zup.beagle.android.components.ViewHolder, position: Int) {
