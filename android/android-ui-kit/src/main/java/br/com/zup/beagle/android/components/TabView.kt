...
@RegisterWidget
data class TabView(
    val children: List<_root_ide_package_.br.com.zup.beagle.android.components.TabItem>,
...
internal class ContentAdapter(
    private val children: List<_root_ide_package_.br.com.zup.beagle.android.components.TabItem>,
